...
const SetSession = ({ alert, setAlert }) => {
  ...
  const reAdjust = () => {
    ...
    const newDay = weekDaySession.map((x, i) => ({
      ...x,
      session_number: i + 1,
    }));
    ...
    const newEnd = weekEndSession.map((x, i) => ({
      ...x,
      session_number: i + 1,
    }));
  ...
  const deleteRules = (x) => {
    ...
    const idx = list.findIndex((item) => item.trim() === x.trim());
  ...
  return (
    <Fragment>
      {alert &&
        alert.map((x) => (
          <div className={`alert alert-${x.alertType}`} role="alert">
            {x.msg}
          </div>
        ))}
      {state ? (
          ...
          <div className="row justify-content-start">
            <div className="col-md-6">
              ...
              <div className=" row justify-content-start ml-2">
                ...
                <div className="col-5">
                  <div
                    className={`ml-4 ${
                      !formData.maxVisitorStatus && "invisible"
                    }`}
                    style={{ width: "350px" }}
                  >
            ...
            <div className="col-md-6">
              ...
              <div className=" row justify-content-start ">
                ...
                <div className="col-5">
                  <div
                    className={`ml-4 ${!formData.maxTimeStatus && "invisible"}`}
                    style={{ width: "280px" }}
                  >
