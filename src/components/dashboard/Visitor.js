        ...
        <div id="content">
          ...
          <div className="container-fluid">
            ...
            <div className="text-center">
              ...
              <div
                className="btn-group collapse show"
                role="group"
              ...
              >
                {floors &&
                  floors.length !== 0 &&
                  floors.map((floor) => Number(floor.FloorNumber)) &&
                  floors
            ...
            <div className="row row-cols-1 row-cols-sm-2 row-cols-lg-3 row-cols-xl-5 justify-content-start">
              {floors &&
                floors.length !== 0 &&
                floors
                  .filter((floor) => Number(floor.FloorNumber) === floorFilter)
                  .map((x) => x.Wards)[0] &&
                floors
                  .filter((floor) => Number(floor.FloorNumber) === floorFilter)
                  .map((current) => current.Wards)[0]
                  .map((ward) => (
                    <IndivualCard
                      rows={ward.Beds}
