                ...
                .map((row, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <TableCell align="left" key={uuidv4()}>
                        {row.checkin?<i className="fa fa-2x fa-check-circle text-success" />:<i className="fa fa-2x fa-times-circle text-danger" />}
                      </TableCell>
                      <TableCell align="left" key={uuidv4()}>
                      {row.checkout?<i className="fa fa-2x fa-check-circle text-success" />:<i className="fa fa-2x fa-times-circle text-danger" />}
