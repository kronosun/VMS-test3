          ...
          <div className="card-body">
            <div className="row no-gutters align-items-center px-2">
              <div className="col mr-2">
                <div
                  className="text-lg font-weight-bold text-dark text-uppercase mb-1"
                  style={{ fontSize: "2.5rem" }}
                >
                  Bed {bed}
                </div>
                <div
                  className="text-xs font-weight-bold text-secondary mb-1"
              ...
              <div className="col-auto">
                <i
                  className={`fas fa-bed fa-2x text-${
                    visitors >= max ? "danger" : "primary"
                  } p-0`}
