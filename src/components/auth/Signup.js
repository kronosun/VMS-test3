...
const Signup = () => {
  ...
  const onSubmit = (e) => {
    ...
    if(password===passwordConfirm){
      signupCognito(email,password,fullName,gender,birthDate,address,phone,profilePicture,ektp);
    }
  };
            ...
            <div className="card o-hidden border-0 shadow-lg my-5">
              <div className="card-body p-0">
                <div className="row justify-content-center">
                  ...
                  <div
                    className="col-lg-5 align-items-center p-3 "
                    style={{ height: "650px" }}
                  >
                    ...
                    {activeStep === steps.length ? (
                      ...
                      <div className="mx-5 p-4 text-left h-70">
